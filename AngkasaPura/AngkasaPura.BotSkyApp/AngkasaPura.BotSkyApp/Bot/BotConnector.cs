...
namespace AngkasaPura.BotSkyApp.Bot
{
    public class BotConnector
    {
        private HttpClient _httpClient;
        private Conversation _lastConversation;
        private string _directLineKey = "_T7Xzm8SFkA.cwA.Ky0.CRwAG4zFseIwPmw-_uFz82HA9gN4qMeOxANVJVekjZs";
        ...
        public async Task<BotMessage> SendMessage(string username, string messageText)
        {
            ...
            return messages.FirstOrDefault(m => m.From == "AngkasaPuraBotSky");//
        }
    }
}
